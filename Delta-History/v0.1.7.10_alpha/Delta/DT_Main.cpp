...
int main()
{
	...
	int main_sele;
	printf("------------------------------------------------\n");
	printf("Delta.-Version:v0.1.7.10_alpha.\n");
	...
	{
		int ba_cal_selector;
		printf("Select the branch program:  1.+  2.-  3.* 4./ 5.x^y  6.√x\n");
	...
	else if (main_sele == 3)
	{
		...
		printf("1.Exchange between degree Celsius(C) and Fahrenhait(F)  2.ASCII Exchange\n");
		scanf_s("%d", &un_exch);
		switch (un_exch)
		{
		case 1:
